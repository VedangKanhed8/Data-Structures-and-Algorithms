...
int find_max_score_for_player1(int* piles , int first_index , int last_index , bool player1_will_move) {
    ...
    if(player1_will_move) {
        ...
        int take_first_pile = piles[last] + find_max_score_for_player1(piles , first_index , last_index - 1, !player1_will_move);
        ...
        int take_first_pile = find_max_score_for_player1(piles , first_index , last_index - 1, !player1_will_move);
